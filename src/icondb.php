...
return [
    ...
    [
        [
            ...
            ["docker-icon", ["dark-blue", "dark-blue"], "/^(?:Dockerfile|docker-compose)|\\.docker(?:file|ignore)$/i", 2, false, null, "/\\.dockerfile$/i", "/^Docker$/i"],
            ...
            ["html5-icon", ["medium-red", "medium-red"], "/\\.(?:html?\\.erb|rhtml)$/i", 2, false, null, "/\\.html\\.erb$/i", "/^HTML$/i"],
            ...
            ["toc-icon", ["medium-cyan", "dark-cyan"], "/\\.toc$/i", 2, false, null, "/\\.toc$/i", "/^Table of Contents$/i"],
            ["calc-icon", ["medium-maroon", "medium-maroon"], "/\\.8x[pk](?:\\.txt)?$/i", 2, false, null, null, null, "/^\\*\\*TI[789]\\d\\*\\*/"],
            ...
            ["_1c-icon", ["medium-red", "medium-red"], "/\\.bsl$/i", null, false, null, "/\\.bsl$/i", "/^1C$|^1[\\W_ \\t]?C[\\W_ \\t]?Enterprise$/i"],
            ["_1c-icon", ["dark-orange", "dark-orange"], "/\\.sdbl$/i", null, false, null, "/\\.sdbl$/i", "/^1C$|^1[\\W_ \\t]?C[\\W_ \\t]?Query$/i"],
            ["_1c-icon", ["dark-red", "dark-red"], "/\\.os$/i"],
            ["_1c-alt-icon", ["medium-red", "dark-red"], "/\\.mdo$/i"],
            ["abap-icon", ["medium-orange", "medium-orange"], "/\\.abap$/i", null, false, null, "/\\.abp$/i", "/^ABAP$/i"],
            ["as-icon", ["medium-blue", "medium-blue"], "/\\.swf$/i"],
            ["as-icon", ["medium-red", "medium-red"], "/\\.as$/i", null, false, null, "/\\.(?:flex-config|actionscript(?:\\.\\d+)?)$/i", "/^ActionScript$|^(?:ActionScript\\s*3|as3)$/i"],
            ["as-icon", ["medium-yellow", "dark-yellow"], "/\\.jsfl$/i"],
            ["as-icon", ["dark-red", "dark-red"], "/\\.swc$/i"],
            ["ada-icon", ["medium-blue", "medium-blue"], "/\\.(?:ada|adb|ads)$/i", null, false, null, "/\\.ada$/i", "/^Ada$|^(?:ada95|ada2005)$/i"],
            ...
            ["psd-icon", ["medium-blue", "medium-blue"], "/\\.psd$/i", null, false, null, null, null, "/^8BPS/"],
            ...
            ["alloy-icon", ["medium-red", "medium-red"], "/\\.als$/i", null, false, null, "/\\.alloy$/i", "/^Alloy$/i"],
            ["alpine-icon", ["dark-blue", "dark-blue"], "/(?:\\.|^)APKBUILD$/"],
            ["ampl-icon", ["dark-maroon", "dark-maroon"], "/\\.ampl$/i", null, false, null, "/\\.ampl$/i", "/^AMPL$/i"],
            ["sun-icon", ["medium-yellow", "dark-yellow"], "/\\.ansiweatherrc$/i"],
            ["antlr-icon", ["medium-red", "medium-red"], "/\\.g$/i", null, false, "/^antlr$/", "/\\.antlr$/i", "/^antlr$/i"],
            ["antlr-icon", ["medium-orange", "medium-orange"], "/\\.g4$/i"],
            ["apache-icon", ["dark-red", "dark-red"], "/\\.apacheconf$/i", null, false, null, "/\\.apache-config$/i", "/^Apache$|^(?:aconf|ApacheConf)$/i"],
            ["apache-icon", ["medium-purple", "medium-purple"], "/apache2[\\\\\\/]magic$/i", null, true],
            ["api-icon", ["medium-blue", "medium-blue"], "/\\.apib$/i", null, false, null, "/\\.apib$/i", "/^API Blueprint$/i"],
            ["apl-icon", ["dark-cyan", "dark-cyan"], "/\\.apl$/i", null, false, "/^apl$/", "/\\.apl$/i", "/^apl$/i"],
            ["apl-icon", ["medium-maroon", "medium-maroon"], "/\\.apl\\.history$/i"],
            ["apple-icon", ["medium-purple", "medium-purple"], "/\\.(?:applescript|scpt)$/i", null, false, "/^osascript$/", "/\\.applescript$/i", "/^Apple$|^[0o]sascript$/i"],
            ["arc-icon", ["medium-blue", "medium-blue"], "/\\.arc$/i"],
            ["arduino-icon", ["dark-cyan", "dark-cyan"], "/\\.ino$/i", null, false, null, "/\\.arduino$/i", "/^Arduino$/i"],
            ["asciidoc-icon", ["medium-blue", "medium-blue"], "/\\.(?:ad|adoc|asc|asciidoc)$/i", null, false, null, "/\\.asciidoc$/i", "/^AsciiDoc$/i"],
            ["asp-icon", ["dark-blue", "dark-blue"], "/\\.asp$/i", null, false, null, "/\\.asp$/i", "/^[Aa][Ss][Pp][\\W_ \\t]?[Nn][Ee][Tt]$|^aspx(?:-vb)?$/"],
            ...
            ["binary-icon", ["medium-red", "medium-red"], "/\\.(?:l?a|[ls]?o|out|s|a51|n?asm|axf|elf|prx|puff|was[mt]|z80)$|\\.rpy[bc]$/i", null, false, null, "/(?:^|\\.)(?:a[rs]m|x86|z80|lc-?3|cpu12|x86asm|m68k|assembly|avr(?:dis)?asm|dasm)(?:\\.|$)/i", "/^Assembly$|^n?asm$/i"],
            ["binary-icon", ["dark-blue", "dark-blue"], "/\\.agc$|\\.d-objdump$/i", null, false, null, "/\\.source\\.agc$/i", "/^Assembly$|^(?:Virtual\\s*)?AGC$|^Apollo(?:[-_\\s]*11)?\\s*Guidance\\s*Computer$/i"],
            ["binary-icon", ["dark-green", "dark-green"], "/\\.ko$/i"],
            ["binary-icon", ["medium-blue", "medium-blue"], "/\\.lst$/i", null, false, "/^lst-cpu12$/", "/\\.lst-cpu12$/i", "/^Assembly$|^lst[\\W_ \\t]?cpu12$/i"],
            ...
            ["ats-icon", ["medium-red", "medium-red"], "/\\.dats$/i", null, false, null, "/\\.ats$/i", "/^ATS$|^ats2$/i"],
            ...
            ["audio-icon", ["medium-red", "medium-red"], "/\\.mp3$/i", null, false, null, null, null, "/^\\xFF\\xFB|^ID3/"],
            ["audio-icon", ["dark-yellow", "dark-yellow"], "/\\.wav$/i", null, false, null, null, null, "/^RIFF(?!.+WEBP)/"],
            ["audio-icon", ["dark-cyan", "dark-cyan"], "/\\.(?:aac|ac3|m4p)$/i", null, false, null, null, null, "/^\\x0Bw/"],
            ["audio-icon", ["medium-purple", "medium-purple"], "/\\.aif[fc]?$/i", null, false, null, null, null, "/^FORM.{4}AIFF/"],
            ["audio-icon", ["medium-cyan", "medium-cyan"], "/\\.au$/i", null, false, null, null, null, "/^\\.snd|^dns\\./"],
            ["audio-icon", ["dark-red", "dark-red"], "/\\.flac$/i", null, false, null, null, null, "/^fLaC/"],
            ["audio-icon", ["medium-red", "medium-red"], "/\\.f4[ab]$/i", null, false, null, null, null, "/^FLV\\x01\\x04/"],
            ["audio-icon", ["medium-cyan", "medium-cyan"], "/\\.m4a$/i", null, false, null, null, null, "/^.{4}ftypM4A/"],
            ["audio-icon", ["dark-green", "dark-green"], "/\\.(?:mpc|mp\\+)$/i", null, false, null, null, null, "/^MPCK/"],
            ["audio-icon", ["dark-orange", "dark-orange"], "/\\.oga$/i"],
            ["audio-icon", ["dark-maroon", "dark-maroon"], "/\\.opus$/i", null, false, null, null, null, "/OpusHead/"],
            ["audio-icon", ["dark-blue", "dark-blue"], "/\\.r[am]$/i", null, false, null, null, null, "/^\\.RMF/"],
            ["audio-icon", ["medium-blue", "medium-blue"], "/\\.wma$/i"],
            ["augeas-icon", ["dark-orange", "dark-orange"], "/\\.aug$/i"],
            ["ahk-icon", ["dark-blue", "dark-blue"], "/\\.ahk$/i", null, false, "/^ahk$/", "/\\.ahk$/i", "/^AutoHotkey$|^ahk$/i"],
            ["ahk-icon", ["dark-purple", "dark-purple"], "/\\.ahkl$/i"],
            ["autoit-icon", ["medium-purple", "medium-purple"], "/\\.au3$/i", null, false, null, "/(?:^|\\.)autoit(?:\\.|$)/i", "/^AutoIt$|^(?:AutoIt3|AutoItScript|au3)$/i"],
            ["terminal-icon", ["medium-blue", "medium-blue"], "/\\.awk$/i", null, false, "/^awk$/", "/\\.awk$/i", "/^awk$/i"],
            ["terminal-icon", ["medium-red", "medium-red"], "/\\.gawk$/i", null, false, "/^gawk$/", "/\\.gawk$/i", "/^AWK$|^gawk$/i"],
            ["terminal-icon", ["medium-maroon", "medium-maroon"], "/\\.mawk$/i", null, false, "/^mawk$/", "/\\.mawk$/i", "/^AWK$|^mawk$/i"],
            ["terminal-icon", ["dark-green", "dark-green"], "/\\.nawk$/i", null, false, "/^nawk$/", "/\\.nawk$/i", "/^AWK$|^nawk$/i"],
            ...
            ["bibtex-icon", ["medium-yellow", "dark-yellow"], "/\\.bib$/i", null, false, "/^bibtex$/", "/\\.bibtex$/i", "/^bibtex$/i"],
            ["bibtex-icon", ["medium-green", "dark-green"], "/\\.bst$/i"],
            ["gnu-icon", ["medium-red", "medium-red"], "/\\.bison$/i", null, false, null, "/\\.bison$/i", "/^Bison$/i"],
            ...
            ["bluespec-icon", ["dark-blue", "dark-blue"], "/\\.bsv$/i", null, false, null, "/\\.bsv$/i", "/^Bluespec$/i"],
            ["boo-icon", ["medium-green", "medium-green"], "/\\.boo$/i", null, false, null, "/\\.boo(?:\\.unity)?$/i", "/^Boo$/i"],
            ["boot-icon", [null, null], "/\\.boot$/i"],
            ["brain-icon", ["dark-pink", "dark-pink"], "/\\.bf?$/i", null, false, null, "/\\.(?:bf|brainfuck)$/i", "/^Brainfuck$|^(?:bf|Brainf\\**ck)$/i"],
            ["brew-icon", ["medium-orange", "medium-orange"], "/^Brewfile$/"],
            ["bro-icon", ["dark-cyan", "dark-cyan"], "/\\.bro$/i", null, false, null, "/\\.bro$/i", "/^Bro$/i"],
            ["byond-icon", ["medium-blue", "medium-blue"], "/\\.dm$/i", null, false, null, "/\\.dm$/i", "/^BYOND$|^(?:DM|Dream\\s*Maker(?:\\s*Script)?)$/i"],
            ["c-icon", ["medium-blue", "medium-blue"], "/\\.c$/i", null, false, "/^tcc$/", "/\\.c$/i", "/^C$/i"],
            ...
            ["csharp-icon", ["medium-blue", "dark-blue"], "/\\.cs$/i", null, false, null, "/\\.cs$/i", "/^C#$|^c\\s*sharp$/i"],
            ["csscript-icon", ["dark-green", "dark-green"], "/\\.csx$/i", null, false, null, "/\\.csx$/i", "/^C#-Script$/i"],
            ["cpp-icon", ["medium-blue", "dark-blue"], "/\\.c[+px]{2}$|\\.cc$/i", null, false, null, "/\\.cpp$/i", "/^C\\+\\+$|c[-_]?pp|cplusplus/i"],
            ...
            ["cabal-icon", ["medium-cyan", "medium-cyan"], "/\\.cabal$/i", null, false, null, "/\\.cabal$/i", "/^Cabal$/i"],
            ["cake-icon", ["medium-yellow", "medium-yellow"], "/\\.cake$/i", null, false, null, "/\\.cake$/i", "/^Cake$/i"],
            ...
            ["chapel-icon", ["medium-green", "medium-green"], "/\\.chpl$/i", null, false, null, "/\\.chapel$/i", "/^Chapel$|^chpl$/i"],
            ["chrome-icon", ["medium-red", "medium-red"], "/\\.crx$/i", null, false, null, null, null, "/^Cr24/"],
            ["chuck-icon", ["medium-green", "medium-green"], "/\\.ck$/i", null, false, null, "/\\.chuck$/i", "/^ChucK$/i"],
            ["cirru-icon", ["medium-pink", "dark-pink"], "/\\.cirru$/i", null, false, null, "/\\.cirru$/i", "/^Cirru$/i"],
            ["clarion-icon", ["medium-orange", "medium-orange"], "/\\.clw$/i", null, false, null, "/\\.clarion$/i", "/^Clarion$/i"],
            ["clean-icon", ["dark-cyan", "dark-cyan"], "/\\.icl$/i", null, false, "/^clean$/", "/\\.clean$/i", "/^clean$/i"],
            ["clean-icon", ["medium-cyan", "medium-cyan"], "/\\.dcl$/i"],
            ["clean-icon", ["medium-blue", "medium-blue"], "/\\.abc$/i"],
            ["click-icon", ["medium-yellow", "medium-yellow"], "/\\.click$/i", null, false, null, "/\\.click$/i", "/^Click$|^Click!$/i"],
            ["clips-icon", ["dark-green", "dark-green"], "/\\.clp$/i", null, false, null, "/\\.clips$/i", "/^CLIPS$/i"],
            ["clojure-icon", ["medium-blue", "dark-blue"], "/\\.clj$/i", null, false, "/^clojure$/", "/\\.clojure$/i", "/^cl[0o]jure$/i"],
            ...
            ["cmake-icon", ["medium-green", "medium-green"], "/\\.cmake$/i", null, false, "/^cmake$/", "/\\.cmake$/i", "/^cmake$/i"],
            ["cmake-icon", ["medium-red", "medium-red"], "/^CMakeLists\\.txt$/"],
            ["coffee-icon", ["medium-maroon", "medium-maroon"], "/\\.coffee$/i", null, false, "/^coffee$/", "/\\.coffee$/i", "/^CoffeeScript$|^Coffee(?:-Script)?$/i"],
            ["coffee-icon", ["dark-maroon", "dark-maroon"], "/\\.cjsx$/i"],
            ["coffee-icon", ["light-maroon", "light-maroon"], "/\\.litcoffee$/i", null, false, "/^litcoffee$/", "/\\.litcoffee$/i", "/^CoffeeScript$|^litc[0o]ffee$/i"],
            ["coffee-icon", ["medium-blue", "medium-blue"], "/\\.iced$/i"],
            ["cf-icon", ["light-cyan", "light-cyan"], "/\\.cfc$/i", null, false, null, "/\\.cfscript$/i", "/^ColdFusion$|^(?:CFC|CFScript)$/i"],
            ["cf-icon", ["medium-cyan", "medium-cyan"], "/\\.cfml?$/i", null, false, null, "/\\.cfml?$/i", "/^ColdFusion$|^(?:cfml?|ColdFusion\\s*HTML)$/i"],
            ["khronos-icon", ["medium-orange", "medium-orange"], "/\\.dae$/i"],
            ["cl-icon", ["medium-orange", "medium-orange"], "/\\.cl$/i", null, false, "/^(?:c?lisp|sbcl|[ec]cl)$/", "/\\.common-lisp$/i", "/^Common Lisp$|^c?lisp$/i"],
            ["cp-icon", ["medium-maroon", "medium-maroon"], "/\\.cp$/i"],
            ["cp-icon", ["dark-red", "dark-red"], "/\\.cps$/i"],
            ["zip-icon", [null, null], "/\\.(?:zip|z|xz)$/i", null, false, null, null, null, "/^(?:\\x50\\x4B(?:\\x03\\x04|\\x05\\x06|\\x07|\\x08)|\\x1F[\\x9D\\xA0]|BZh|RNC[\\x01\\x02]|\\xD0\\xCF\\x11\\xE0)/"],
            ["zip-icon", ["medium-blue", "medium-blue"], "/\\.rar$/i", null, false, null, null, null, "/^Rar!\\x1A\\x07\\x01?\\0/"],
            ["zip-icon", ["dark-blue", "dark-blue"], "/\\.t?gz$|\\.tar$|\\.whl$/i", null, false, null, null, null, "/^\\x1F\\x8B/"],
            ["zip-icon", ["medium-maroon", "medium-maroon"], "/\\.(?:lzo?|lzma|tlz|tar\\.lzma)$/i", null, false, null, null, null, "/^LZIP/"],
            ["zip-icon", ["medium-maroon", "medium-maroon"], "/\\.7z$/i", null, false, null, null, null, "/^7z\\xBC\\xAF\\x27\\x1C/"],
            ["zip-icon", ["medium-red", "medium-red"], "/\\.apk$|\\.gem$/i"],
            ["zip-icon", ["dark-cyan", "dark-cyan"], "/\\.bz2$/i"],
            ["zip-icon", ["medium-blue", "medium-blue"], "/\\.iso$/i", null, false, null, null, null, "/^\\x45\\x52\\x02\\0{3}|^\\x8B\\x45\\x52\\x02/"],
            ...
            ["zip-icon", ["dark-orange", "dark-orange"], "/\\.xar$/i", null, false, null, null, null, "/^xar!/"],
            ["zip-icon", ["light-orange", "light-orange"], "/\\.egg$/i"],
            ["config-icon", ["medium-yellow", "medium-yellow"], "/\\.(?:ini|desktop|directory|cfg|conf|prefs)$/i", null, false, null, "/\\.ini$/i", "/^d[0o]sini$/i"],
            ["config-icon", ["medium-purple", "medium-purple"], "/\\.properties$/i", null, false, null, "/\\.java-properties$/i"],
            ...
            ["config-icon", ["dark-red", "dark-red"], "/\\.git[\\/\\\\](?:config|info[\\/\\\\]\\w+)$/", null, true],
            ["config-icon", ["dark-orange", "dark-orange"], "/^\\/(?:private\\/)?etc\\/(?:[^\\/]+\\/)*[^\\/]*\\.(?:cf|conf|ini)(?:\\.default)?$/i", null, true],
            ["config-icon", ["medium-maroon", "medium-maroon"], "/^\\/(?:private\\/)?etc\\/(?:aliases|auto_(?:home|master)|ftpusers|group|gettytab|hosts(?:\\.equiv)?|manpaths|networks|paths|protocols|services|shells|sudoers|ttys)$/i", null, true],
            ["coq-icon", ["medium-maroon", "medium-maroon"], "/\\.coq$/i", null, false, null, "/\\.coq$/i", "/^Coq$/i"],
            ["creole-icon", ["medium-blue", "medium-blue"], "/\\.creole$/i", null, false, null, "/\\.creole$/i", "/^Creole$/i"],
            ["crystal-icon", ["medium-cyan", "medium-cyan"], "/\\.e?cr$/i", null, false, "/^crystal$/", "/\\.crystal$/i", "/^Crystal$/i"],
            ["csound-icon", ["medium-maroon", "medium-maroon"], "/\\.orc$/i", null, false, null, "/\\.csound$/i", "/^Csound$|^cs[0o]und[\\W_ \\t]?[0o]rc$/i"],
            ["csound-icon", ["dark-orange", "dark-orange"], "/\\.udo$/i"],
            ["csound-icon", ["dark-maroon", "dark-maroon"], "/\\.csd$/i", null, false, null, "/\\.csound-document$/i", "/^Csound$|^cs[0o]und[\\W_ \\t]?csd$/i"],
            ["csound-icon", ["dark-blue", "dark-blue"], "/\\.sco$/i", null, false, null, "/\\.csound-score$/i", "/^Csound$|^cs[0o]und[\\W_ \\t]?sc[0o]$/i"],
            ["css3-icon", ["medium-blue", "medium-blue"], "/\\.css$/i", null, false, "/^css$/", "/\\.css$/i", "/^css$/i"],
            ["css3-icon", ["dark-blue", "dark-blue"], "/\\.less$/i", null, false, "/^less$/", "/\\.less$/i", "/^CSS$|^less$/i"],
            ["cucumber-icon", ["medium-green", "medium-green"], "/\\.feature$/i", null, false, null, "/(?:^|\\.)(?:gherkin\\.feature|cucumber\\.steps)(?:\\.|$)/i", "/^Cucumber$|^gherkin$/i"],
            ["nvidia-icon", ["medium-green", "medium-green"], "/\\.cu$/i", null, false, null, "/\\.cuda(?:-c\\+\\+)?$/i", "/^CUDA$/i"],
            ["nvidia-icon", ["dark-green", "dark-green"], "/\\.cuh$/i"],
            ["cython-icon", ["medium-orange", "medium-orange"], "/\\.pyx$/i", null, false, null, "/\\.cython$/i", "/^Cython$|^pyrex$/i"],
            ["cython-icon", ["medium-blue", "medium-blue"], "/\\.pxd$/i"],
            ["cython-icon", ["dark-blue", "dark-blue"], "/\\.pxi$/i"],
            ["dlang-icon", ["medium-red", "medium-red"], "/\\.di?$/i", null, false, null, "/\\.d$/i", "/^D$/i"],
            ["yang-icon", ["medium-red", "medium-red"], "/\\.dnh$/i", null, false, null, "/\\.danmakufu$/i", "/^Danmakufu$/i"],
            ["darcs-icon", ["medium-green", "medium-green"], "/\\.d(?:arcs)?patch$/i"],
            ["dart-icon", ["medium-cyan", "medium-cyan"], "/\\.dart$/i", null, false, "/^dart$/", "/\\.dart$/i", "/^Dart$/i"],
            ["dashboard-icon", ["medium-orange", "medium-orange"], "/\\.s[kl]im$/i", null, false, "/^slim$/", "/\\.slim$/i", "/^slim$/i"],
            ...
            ["database-icon", ["dark-yellow", "dark-yellow"], "/\\.json5$/i", null, false, "/^json5$/", "/\\.json5$/i", "/^js[0o]n5$/i"],
            ["database-icon", ["medium-red", "medium-red"], "/\\.http$|\\.pot?$/i"],
            ["database-icon", ["medium-orange", "medium-orange"], "/\\.ndjson$|\\.pytb$/i", null, false, null, "/\\.python\\.traceback$/i"],
            ["database-icon", ["light-blue", "light-blue"], "/\\.fea$/i", null, false, null, "/\\.opentype$/i", "/^afdk[0o]$/i"],
            ["database-icon", ["medium-purple", "medium-purple"], "/\\.json\\.eex$|\\.edn$/i"],
            ["database-icon", ["dark-cyan", "dark-cyan"], "/\\.proto$/i", null, false, null, "/\\.protobuf$/i", "/^(?:protobuf|Protocol\\s*Buffers?)$/i"],
            ...
            ["database-icon", ["medium-cyan", "medium-cyan"], "/\\.ttl$/i", null, false, null, "/\\.turtle$/i"],
            ["database-icon", ["medium-blue", "medium-blue"], "/\\.syntax$/i"],
            ["database-icon", ["dark-red", "dark-red"], "/[\\/\\\\](?:magic[\\/\\\\]Magdir|file[\\/\\\\]magic)[\\/\\\\][-.\\w]+$|lib[\\\\\\/]icons[\\\\\\/]\\.icondb\\.js$/i", null, true],
            ...
            ["diff-icon", ["medium-orange", "medium-orange"], "/\\.diff$/i", null, false, null, "/\\.diff$/i", "/^Diff$|^udiff$/i"],
            ["earth-icon", ["medium-blue", "medium-blue"], "/\\.zone$/i"],
            ["earth-icon", ["medium-green", "medium-green"], "/\\.arpa$/i"],
            ["earth-icon", ["dark-blue", "dark-blue"], "/^CNAME$/"],
            ["doxygen-icon", ["medium-blue", "medium-blue"], "/^Doxyfile$/", null, false, null, "/\\.doxygen$/i", "/^Doxyfile$/i"],
            ["dyalog-icon", ["medium-orange", "medium-orange"], "/\\.dyalog$/i", null, false, "/^dyalog$/"],
            ["dylib-icon", ["medium-cyan", "medium-cyan"], "/\\.(?:dylib|bundle)$/i"],
            ["e-icon", ["medium-green", "medium-green"], "/\\.E$/", null, false, "/^rune$/"],
            ["eagle-icon", ["medium-red", "medium-red"], "/\\.sch$/i"],
            ["eagle-icon", ["dark-red", "dark-red"], "/\\.brd$/i"],
            ["ec-icon", ["dark-blue", "dark-blue"], "/\\.ec$/i", null, false, "/^ec$/", "/\\.ec$/i", "/^ec$/i"],
            ...
            ["editorconfig-icon", ["medium-orange", "medium-orange"], "/\\.editorconfig$/i", null, false, null, "/\\.editorconfig$/i", "/^EditorConfig$/i"],
            ["eiffel-icon", ["medium-cyan", "medium-cyan"], "/\\.e$/", null, false, null, "/\\.eiffel$/i", "/^Eiffel$/i"],
            ["elixir-icon", ["dark-purple", "dark-purple"], "/\\.ex$/i", null, false, "/^elixir$/", "/\\.elixir$/i", "/^elixir$/i"],
            ["elixir-icon", ["medium-purple", "medium-purple"], "/\\.(?:exs|eex)$/i"],
            ["elixir-icon", ["light-purple", "light-purple"], "/mix\\.exs?$/i"],
            ["elm-icon", ["medium-blue", "medium-blue"], "/\\.elm$/i", null, false, null, "/\\.elm$/i", "/^Elm$/i"],
            ["emacs-icon", ["medium-purple", "medium-purple"], "/(?:^|\\.)(?:el|_?emacs|spacemacs|emacs\\.desktop|abbrev[-_]defs)$/i", null, false, "/^emacs$/", "/\\.emacs\\.lisp$/i", "/^Emacs Lisp$|^elisp$/i"],
            ["emacs-icon", ["dark-purple", "dark-purple"], "/(?:^|\\.)(?:elc|eld)$/i", null, false, null, null, null, "/^;ELC\\x17\\0{3}/"],
            ["at-icon", ["medium-red", "dark-red"], "/^(?:authors|owners)$/i"],
            ["em-icon", ["medium-red", "medium-red"], "/\\.emberscript$/i", null, false, null, "/\\.ember(?:script)?$/i", "/^EmberScript$/i"],
            ["mustache-icon", ["medium-blue", "medium-blue"], "/\\.em(?:blem)?$/i", null, false, null, "/\\.emblem$/i", "/^Emblem$/i"],
            ["eq-icon", ["medium-orange", "medium-orange"], "/\\.eq$/i", null, false, null, "/\\.eq$/i", "/^EQ$/i"],
            ["erlang-icon", ["medium-red", "medium-red"], "/\\.erl$/i", null, false, "/^escript$/", "/\\.erlang$/i", "/^Erlang$/i"],
            ...
            ["factor-icon", ["medium-orange", "medium-orange"], "/\\.factor$/i", null, false, null, "/\\.factor$/i", "/^Factor$/i"],
            ["factor-icon", ["dark-orange", "dark-orange"], "/\\.factor-rc$/i"],
            ["factor-icon", ["medium-red", "medium-red"], "/\\.factor-boot-rc$/i"],
            ["fancy-icon", ["dark-blue", "dark-blue"], "/\\.fy$/i", null, false, "/^fancy$/", "/\\.fancy$/i", "/^fancy$/i"],
            ["fancy-icon", ["medium-blue", "medium-blue"], "/\\.fancypack$/i"],
            ["fancy-icon", ["medium-green", "medium-green"], "/^Fakefile$/"],
            ["fantom-icon", ["medium-blue", "medium-blue"], "/\\.fan$/i", null, false, null, "/\\.fan(?:tom)?$/i", "/^Fantom$/i"],
            ...
            ["font-icon", ["dark-blue", "dark-blue"], "/\\.woff2$/i", null, false, null, null, null, "/^wOF2/"],
            ["font-icon", ["medium-blue", "medium-blue"], "/\\.woff$/i", null, false, null, null, null, "/^wOFF/"],
            ["font-icon", ["light-green", "light-green"], "/\\.eot$/i", null, false, null, null, null, "/^.{34}LP/"],
            ["font-icon", ["dark-green", "dark-green"], "/\\.ttc$/i", null, false, null, null, null, "/^ttcf/"],
            ["font-icon", ["medium-green", "medium-green"], "/\\.ttf$/i", null, false, null, null, null, "/^\\0\\x01\\0{3}/"],
            ["font-icon", ["dark-yellow", "dark-yellow"], "/\\.otf$/i", null, false, null, null, null, "/^OTTO.*\\0/"],
            ["font-icon", ["dark-red", "dark-red"], "/\\.pfb$/i"],
            ["font-icon", ["medium-red", "medium-red"], "/\\.pfm$/i"],
            ["ff-icon", ["medium-orange", "medium-orange"], "/\\.pe$/i", null, false, "/^fontforge$/", "/\\.source\\.fontforge$/i", "/^FontForge$|^pfaedit$/i"],
            ["ff-icon", ["dark-blue", "dark-blue"], "/\\.sfd$/i", null, false, null, "/\\.text\\.sfd$/i", "/^FontForge$/i"],
            ["fortran-icon", ["medium-maroon", "medium-maroon"], "/\\.f$/i", null, false, null, "/\\.fortran\\.?(?:modern|punchcard)?$/i", "/^Fortran$/i"],
            ["fortran-icon", ["medium-green", "medium-green"], "/\\.f90$/i", null, false, null, "/\\.fortran\\.free$/i", "/^Fortran$/i"],
            ["fortran-icon", ["medium-red", "medium-red"], "/\\.f03$/i"],
            ["fortran-icon", ["medium-blue", "medium-blue"], "/\\.f08$/i"],
            ["fortran-icon", ["medium-maroon", "medium-maroon"], "/\\.f77$/i", null, false, null, "/\\.fortran\\.fixed$/i", "/^Fortran$/i"],
            ["fortran-icon", ["dark-pink", "dark-pink"], "/\\.f95$/i"],
            ["fortran-icon", ["dark-cyan", "dark-cyan"], "/\\.for$/i"],
            ["fortran-icon", ["dark-yellow", "dark-yellow"], "/\\.fpp$/i"],
            ["freemarker-icon", ["medium-blue", "medium-blue"], "/\\.ftl$/i", null, false, null, "/\\.ftl$/i", "/^FreeMarker$|^ftl$/i"],
            ["frege-icon", ["dark-red", "dark-red"], "/\\.fr$/i"],
            ["fsharp-icon", ["medium-blue", "medium-blue"], "/\\.fs[xi]?$/i", null, false, null, "/\\.fsharp$/i", "/^FSharp$|^f#$/i"],
            ["gml-icon", ["medium-green", "medium-green"], "/\\.gml$/i"],
            ["gams-icon", ["dark-red", "dark-red"], "/\\.gms$/i", null, false, null, "/\\.gams(?:-lst)?$/i", "/^GAMS$/i"],
            ["gap-icon", ["medium-yellow", "dark-yellow"], "/\\.gap$/i", null, false, "/^gap$/", "/\\.gap$/i", "/^gap$/i"],
            ["gap-icon", ["dark-blue", "dark-blue"], "/\\.gi$/i"],
            ["gap-icon", ["medium-orange", "medium-orange"], "/\\.tst$/i"],
            ["gdb-icon", ["medium-green", "dark-green"], "/\\.gdb$/i", null, false, "/^gdb$/", "/\\.gdb$/i", "/^gdb$/i"],
            ["gdb-icon", ["medium-cyan", "dark-cyan"], "/gdbinit$/i"],
            ["godot-icon", ["medium-blue", "medium-blue"], "/\\.gd$/i", null, false, null, "/\\.gdscript$/i", "/^GDScript$/i"],
            ...
            ["gears-icon", ["dark-orange", "dark-orange"], "/\\.dll$/i", null, false, null, null, null, "/^PMOCCMOC/"],
            ["code-icon", ["medium-blue", "medium-blue"], "/\\.xml$|\\.config$|\\.4th$|\\.cocci$|\\.dyl$|\\.dylan$|\\.ecl$|\\.forth$|\\.launch$|\\.manifest$|\\.menu$|\\.srdf$|\\.st$|\\.ui$|\\.wsf$|\\.x3d$|\\.xaml$/i", null, false, null, null, null, "/^<\\?xml /"],
            ["code-icon", ["dark-red", "dark-red"], "/\\.rdf$|\\.capnp$|\\.dotsettings$|\\.flex$|\\.fsh$|\\.fsproj$|\\.prw$|\\.xproj$/i", null, false, null, "/\\.capnp$/i"],
            ...
            ["code-icon", ["medium-green", "medium-green"], "/\\.abnf$|\\.ditaval$|\\.storyboard$|\\.xmi$|\\.yacc$/i", null, false, "/^abnf$/", "/\\.abnf$/i", "/^abnf$/i"],
            ["code-icon", ["medium-purple", "medium-purple"], "/\\.aepx$|\\.dita$|\\.grace$|\\.lid$|\\.nproj$/i"],
            ["code-icon", ["dark-cyan", "dark-cyan"], "/\\.agda$|\\.plist$|\\.wisp$|\\.xlf$|\\.xslt$/i", null, false, null, "/\\.plist$/i"],
            ["code-icon", ["medium-orange", "medium-orange"], "/\\.appxmanifest$|\\.befunge$|\\.fun$|\\.muf$|\\.xul$/i"],
            ["code-icon", ["medium-cyan", "medium-cyan"], "/\\.ash$|\\.asn1?$|\\.lagda$|\\.lex$|\\.props$|\\.resx$|\\.smt2$|\\.vsh$|\\.xsl$|\\.yy$/i", null, false, "/^xsl$/", "/\\.xsl$/i"],
            ["code-icon", ["dark-blue", "dark-blue"], "/\\.axml$|\\.bmx$|\\.brs$|\\.ccxml$|\\.clixml$|\\.fth$|\\.intr$|\\.mdpolicy$|\\.mtml$|\\.myt$|\\.xsd$/i", null, false, "/^brightscript$/", "/\\.brightscript$/i"],
            ["code-icon", ["medium-maroon", "medium-maroon"], "/\\.bnf$|\\.cbl$|\\.cob$|\\.cobol$|\\.fxml$/i", null, false, "/^bnf$/", "/\\.bnf$/i", "/^bnf$/i"],
            ["code-icon", ["dark-maroon", "dark-maroon"], "/\\.ccp$|\\.cpy$|\\.mxml$/i"],
            ["code-icon", ["medium-red", "medium-red"], "/\\.ch$|\\.cw$|\\.ebnf$|\\.iml$|\\.jflex$|\\.m4$|\\.mask$|\\.mumps$|\\.prg$|\\.pt$|\\.rl$|\\.sml$|\\.targets$|\\.webidl$|\\.wsdl$|\\.xacro$|\\.xliff$/i", null, false, "/^ebnf$/", "/\\.ebnf$/i"],
            ...
            ["code-icon", ["dark-yellow", "dark-yellow"], "/\\.jsproj$|\\.ohm$|\\.sgml?$/i", null, false, "/^ohm$/", "/\\.ohm$/i"],
            ["code-icon", ["dark-blue", "dark-blue"], "/\\.mq[45h]$/i", null, false, null, "/(?:^|\\.)mq[45](?=\\.|$)/i"],
            ["code-icon", ["light-green", "light-green"], "/\\.odd$/i"],
            ["code-icon", ["light-blue", "light-blue"], "/\\.psc1$|\\.smt$/i", null, false, "/boolector|cvc4|mathsat5|opensmt|smtinterpol|smt-rat|stp|verit|yices2|z3/", "/\\.smt$/i"],
            ...
            ["genshi-icon", ["medium-red", "medium-red"], "/\\.kid$/i", null, false, null, "/\\.genshi$/i", "/^Genshi$|^xml\\+(?:genshi|kid)$/i"],
            ["gentoo-icon", ["dark-cyan", "dark-cyan"], "/\\.ebuild$/i", null, false, null, "/\\.ebuild$/i", "/^Gentoo$/i"],
            ["gentoo-icon", ["medium-blue", "medium-blue"], "/\\.eclass$/i"],
            ["git-icon", ["medium-red", "medium-red"], "/^\\.git|^\\.keep$|\\.mailmap$/i", null, false, null, "/\\.git-(?:commit|config|rebase)$/i", "/^Git$/i"],
            ...
            ["gn-icon", ["dark-blue", "dark-blue"], "/\\.gn$/i", null, false, "/^gn$/", "/\\.gn$/i", "/^gn$/i"],
            ["gn-icon", ["medium-blue", "medium-blue"], "/\\.gni$/i"],
            ["gnu-icon", ["medium-red", "dark-red"], "/\\.(?:gnu|gplv[23])$/i"],
            ["graph-icon", ["medium-red", "medium-red"], "/\\.(?:gp|plo?t|gnuplot)$/i", null, false, "/^gnuplot$/", "/\\.gnuplot$/i", "/^Gnuplot$/i"],
            ["go-icon", ["medium-blue", "medium-blue"], "/\\.go$/i", null, false, null, "/\\.go(?:template)?$/i", "/^Go$/i"],
            ["golo-icon", ["medium-orange", "medium-orange"], "/\\.golo$/i", null, false, null, "/\\.golo$/i", "/^Golo$/i"],
            ["gosu-icon", ["medium-blue", "medium-blue"], "/\\.gs$/i", null, false, null, "/\\.gosu(?:\\.\\d+)?$/i", "/^Gosu$/i"],
            ["gosu-icon", ["medium-green", "medium-green"], "/\\.gst$/i"],
            ["gosu-icon", ["dark-green", "dark-green"], "/\\.gsx$/i"],
            ["gosu-icon", ["dark-blue", "dark-blue"], "/\\.vark$/i"],
            ["gradle-icon", ["medium-blue", "medium-blue"], "/\\.gradle$/i", null, false, null, "/\\.gradle$/i", "/^Gradle$/i"],
            ["gradle-icon", ["dark-purple", "dark-purple"], "/gradlew$/i"],
            ["gf-icon", ["medium-red", "medium-red"], "/\\.gf$/i"],
            ["graphql-icon", ["medium-pink", "medium-pink"], "/\\.graphql$/i", null, false, null, "/\\.graphql$/i", "/^GraphQL$/i"],
            ["graphql-icon", ["medium-purple", "medium-purple"], "/\\.gql$/i"],
            ["graphviz-icon", ["medium-blue", "medium-blue"], "/\\.gv$/i", null, false, null, "/\\.dot$/i", "/^Graphviz$/i"],
            ["graphviz-icon", ["dark-cyan", "dark-cyan"], "/\\.dot$/i"],
            ["groovy-icon", ["light-blue", "light-blue"], "/\\.(?:groovy|grt|gtpl|gsp|gvy)$/i", null, false, "/^groovy$/", "/\\.groovy$/i", "/^Groovy$|^gsp$/i"],
            ["hack-icon", ["medium-orange", "medium-orange"], "/\\.hh$/i", null, false, null, "/\\.hack$/i", "/^Hack$/i"],
            ["haml-icon", ["medium-yellow", "medium-yellow"], "/\\.haml$/i", null, false, "/^haml$/", "/\\.haml$/i", "/^haml$/i"],
            ["haml-icon", ["medium-maroon", "medium-maroon"], "/\\.hamlc$/i", null, false, "/^hamlc$/", "/\\.hamlc$/i", "/^Haml$|^hamlc$/i"],
            ["harbour-icon", ["dark-blue", "dark-blue"], "/\\.hb$/i", null, false, null, "/\\.harbour$/i", "/^Harbour$/i"],
            ["hashicorp-icon", ["dark-purple", "dark-purple"], "/\\.hcl$/i", null, false, null, "/(?:^|\\.)(?:hcl|hashicorp)(?:\\.|$)/i", "/^Hashicorp Configuration Language$/i"],
            ["haskell-icon", ["medium-purple", "medium-purple"], "/\\.hs$/i", null, false, "/^runhaskell$/", "/\\.source\\.haskell$/i", "/^Haskell$/i"],
            ["haskell-icon", ["medium-blue", "medium-blue"], "/\\.hsc$/i", null, false, null, "/\\.hsc2hs$/i", "/^Haskell$/i"],
            ["haskell-icon", ["dark-purple", "dark-purple"], "/\\.c2hs$/i", null, false, null, "/\\.c2hs$/i", "/^Haskell$|^C2hs(?:\\s*Haskell)?$/i"],
            ["haskell-icon", ["dark-blue", "dark-blue"], "/\\.lhs$/i", null, false, null, "/\\.latex\\.haskell$/i", "/^Haskell$|^(?:lhaskell|lhs|Literate\\s*Haskell)$/i"],
            ["haxe-icon", ["medium-orange", "medium-orange"], "/\\.hx(?:[sm]l|)?$/", null, false, null, "/(?:^|\\.)haxe(?:\\.\\d+)?$/i", "/^Haxe$/i"],
            ...
            ["html5-icon", ["medium-orange", "medium-orange"], "/\\.x?html?$/i", null, false, null, "/\\.html\\.basic$/i", "/^HTML$|^(?:xhtml|htm)$/i"],
            ["html5-icon", ["medium-red", "medium-red"], "/\\.cshtml$|\\.latte$/i", null, false, "/^latte$/", "/\\.latte$/i"],
            ["html5-icon", ["medium-green", "medium-green"], "/\\.ejs$|\\.kit$|\\.swig$/i", null, false, "/^swig$/", "/\\.swig$/i"],
            ["html5-icon", ["dark-blue", "dark-blue"], "/\\.gohtml$|\\.phtml$/i", null, false, "/^gohtml$/", "/\\.gohtml$/i", "/^HTML$|^g[0o]html$/i"],
            ["html5-icon", ["medium-purple", "medium-purple"], "/\\.html\\.eex$|\\.jsp$/i", null, false, null, "/\\.jsp$/i"],
            ["html5-icon", ["medium-cyan", "medium-cyan"], "/\\.shtml$/i"],
            ["html5-icon", ["dark-red", "dark-red"], "/\\.scaml$/i", null, false, "/^scaml$/", "/\\.scaml$/i", "/^HTML$|^scaml$/i"],
            ["html5-icon", ["medium-red", "medium-red"], "/\\.vash$/i", null, false, "/^vash$/", "/\\.vash$/i", "/^HTML$|^vash$/i"],
            ["html5-icon", ["medium-blue", "medium-blue"], "/\\.dtml$/i", null, false, "/^dtml$/", "/\\.dtml$/i", "/^HTML$|^dtml$/i"],
            ["hy-icon", ["dark-blue", "dark-blue"], "/\\.hy$/i", null, false, null, "/\\.hy$/i", "/^Hy$|^hylang$/i"],
            ["idl-icon", ["medium-blue", "medium-blue"], "/\\.dlm$/i", null, false, null, "/\\.idl$/i", "/^IDL$/i"],
            ["idris-icon", ["dark-red", "dark-red"], "/\\.idr$/i", null, false, null, "/\\.(?:idris|ipkg)$/i", "/^Idris$/i"],
            ["idris-icon", ["medium-maroon", "medium-maroon"], "/\\.lidr$/i"],
            ["igorpro-icon", ["dark-red", "dark-red"], "/\\.ipf$/i"],
            ["image-icon", ["medium-orange", "medium-orange"], "/\\.a?png$|\\.svgz$/i", null, false, null, null, null, "/^.PNG\\r\\n\\x1A\\n/"],
            ["image-icon", ["medium-yellow", "medium-yellow"], "/\\.gif$|\\.ora$|\\.sgi$/i", null, false, null, null, null, "/^GIF8[97]a/"],
            ["image-icon", ["medium-green", "medium-green"], "/\\.jpg$/i", null, false, null, null, null, "/^\\xFF\\xD8\\xFF[\\xDB\\xE0\\xE1]|(?:JFIF|Exif)\\0|^\\xCF\\x84\\x01|^\\xFF\\xD8.+\\xFF\\xD9$/"],
            ["image-icon", ["medium-blue", "medium-blue"], "/\\.ico$/i", null, false, null, null, null, "/^\\0{2}\\x01\\0/"],
            ["image-icon", ["dark-blue", "dark-blue"], "/\\.webp$|\\.iff$|\\.lbm$|\\.liff$|\\.nrrd$|\\.pcx$|\\.vsdx?$/i", null, false, null, null, null, "/^RIFF.{4}WEBPVP8/"],
            ["image-icon", ["medium-red", "medium-red"], "/\\.bmp$/i", null, false, null, null, null, "/^BM/"],
            ["image-icon", ["medium-red", "medium-red"], "/\\.bpg$/i", null, false, null, null, null, "/^BPG\\xFB/"],
            ["image-icon", ["medium-orange", "medium-orange"], "/\\.cin$/i", null, false, null, null, null, "/^\\x80\\x2A\\x5F\\xD7/"],
            ["image-icon", ["dark-green", "dark-green"], "/\\.cd5$/i", null, false, null, null, null, "/^_CD5\\x10\\0/"],
            ["image-icon", ["light-yellow", "light-yellow"], "/\\.cpc$/i"],
            ["image-icon", ["medium-orange", "medium-orange"], "/\\.cr2$/i", null, false, null, null, null, "/^II\\*\\0\\x10\\0{3}CR/"],
            ["image-icon", ["medium-pink", "medium-pink"], "/\\.dcm$|\\.mpo$|\\.pbm$/i", null, false, null, null, null, "/^.{128}DICM/"],
            ["image-icon", ["dark-green", "dark-green"], "/\\.dds$/i", null, false, null, null, null, "/^DDS \\|\\0{3}/"],
            ["image-icon", ["medium-purple", "medium-purple"], "/\\.djvu?$|\\.pxr$/i", null, false, null, null, null, "/^AT&TFORM/"],
            ["image-icon", ["dark-orange", "dark-orange"], "/\\.dpx$|\\.raw$/i", null, false, null, null, null, "/^(?:SDPX|XPDS)/"],
            ["image-icon", ["light-blue", "light-blue"], "/\\.ecw$|\\.sct$/i"],
            ["image-icon", ["dark-yellow", "dark-yellow"], "/\\.exr$/i", null, false, null, null, null, "/^v\\/1\\x01/"],
            ["image-icon", ["medium-cyan", "medium-cyan"], "/\\.fits?$|\\.fts$/i", null, false, null, null, null, "/^SIMPLE  =/"],
            ["image-icon", ["dark-red", "dark-red"], "/\\.flif$|\\.hdp$|\\.heic$|\\.heif$|\\.jxr$|\\.wdp$/i", null, false, null, null, null, "/^FLIF/"],
            ["image-icon", ["medium-blue", "medium-blue"], "/\\.hdr$/i", null, false, null, null, null, "/^#\\?RADIANCE\\n/"],
            ["image-icon", ["medium-pink", "medium-pink"], "/\\.icns$/i", null, false, null, null, null, "/^icns/"],
            ["image-icon", ["dark-green", "dark-green"], "/\\.(?:jp[f2xm]|j2c|mj2)$/i", null, false, null, null, null, "/^\\0{3}\\fjP {2}/"],
            ["image-icon", ["dark-cyan", "dark-cyan"], "/\\.jps$/i"],
            ["image-icon", ["medium-orange", "medium-orange"], "/\\.mng$/i", null, false, null, null, null, "/^.MNG\\r\\n\\x1A\\n/"],
            ["image-icon", ["light-red", "light-red"], "/\\.pgf$/i"],
            ["image-icon", ["light-purple", "light-purple"], "/\\.pict$/i"],
            ["image-icon", ["dark-orange", "dark-orange"], "/\\.tga$/i", null, false, null, null, null, "/TRUEVISION-XFILE\\.\\0$/"],
            ["image-icon", ["medium-red", "medium-red"], "/\\.tiff?$/i", null, false, null, null, null, "/^II\\x2A\\0|^MM\\0\\x2A/"],
            ["image-icon", ["dark-maroon", "dark-maroon"], "/\\.wbm$/i"],
            ["inform7-icon", ["medium-blue", "medium-blue"], "/\\.ni$/i", null, false, null, "/\\.inform-?7?$/i", "/^Inform 7$|^i7$/i"],
            ["inform7-icon", ["dark-blue", "dark-blue"], "/\\.i7x$/i"],
            ["inno-icon", ["dark-blue", "dark-blue"], "/\\.iss$/i", null, false, null, "/\\.inno$/i", "/^Inno Setup$/i"],
            ["io-icon", ["dark-purple", "dark-purple"], "/\\.io$/i", null, false, "/^io$/", "/^source\\.io$/i", "/^Io$/i"],
            ["ioke-icon", ["medium-red", "medium-red"], "/\\.ik$/i", null, false, "/^ioke$/"],
            ["isabelle-icon", ["dark-red", "dark-red"], "/\\.thy$/i", null, false, null, "/\\.isabelle\\.theory$/i", "/^Isabelle$/i"],
            ["isabelle-icon", ["dark-blue", "dark-blue"], "/^ROOT$/"],
            ["j-icon", ["light-blue", "light-blue"], "/\\.ijs$/i", null, false, "/^jconsole$/", "/\\.j$/i", "/^J$/i"],
            ["jade-icon", ["medium-red", "medium-red"], "/\\.jade$/i", null, false, null, "/\\.jade$/i", "/^Jade$/i"],
            ["jake-icon", ["medium-maroon", "dark-maroon"], "/^Jakefile$/"],
            ["jake-icon", ["medium-yellow", "dark-yellow"], "/\\.jake$/i"],
            ["java-icon", ["medium-purple", "medium-purple"], "/\\.java$/i", null, false, null, "/\\.java$/i", "/^Java$/i"],
            ["js-icon", ["medium-yellow", "dark-yellow"], "/\\.js$|\\.es6$|\\.es$/i", null, false, "/^(?:node|iojs)$/", "/\\.js$/i", "/^JavaScript$|^(?:js|node)$/i"],
            ...
            ["jinja-icon", ["dark-red", "dark-red"], "/\\.jinja$/i", null, false, null, "/\\.jinja$/i", "/^Jinja$|^(?:django|htmldjango|html\\+django\\/jinja|html\\+jinja)$/i"],
            ["jinja-icon", ["medium-red", "medium-red"], "/\\.jinja2$/i"],
            ["jsonld-icon", ["medium-blue", "medium-blue"], "/\\.jsonld$/i"],
            ["sql-icon", ["medium-blue", "medium-blue"], "/\\.jq$/i", null, false, null, "/\\.jq$/i", "/^JSONiq$/i"],
            ["jsx-icon", ["medium-blue", "dark-blue"], "/\\.jsx$/i", null, false, null, "/\\.jsx$/i", "/^JSX$/i"],
            ["julia-icon", ["medium-purple", "medium-purple"], "/\\.jl$/i", null, false, null, "/\\.julia$/i", "/^Julia$/i"],
            ["jupyter-icon", ["dark-orange", "dark-orange"], "/\\.ipynb$/i", null, false, null, "/\\.ipynb$/i", "/^(?:ipynb|(?:Jupyter|IPython)\\s*Notebook)$/i"],
            ...
            ["kivy-icon", ["dark-maroon", "dark-maroon"], "/\\.kv$/i", null, false, null, "/\\.kv$/i", "/^Kivy$/i"],
            ["earth-icon", ["medium-green", "medium-green"], "/\\.kml$/i"],
            ["kotlin-icon", ["dark-blue", "dark-blue"], "/\\.kt$/i", null, false, "/^kotlin$/", "/\\.kotlin$/i", "/^k[0o]tlin$/i"],
            ["kotlin-icon", ["medium-blue", "medium-blue"], "/\\.ktm$/i"],
            ["kotlin-icon", ["medium-orange", "medium-orange"], "/\\.kts$/i"],
            ["krl-icon", ["medium-blue", "medium-blue"], "/\\.krl$/i", null, false, null, "/\\.krl$/i", "/^KRL$/i"],
            ["labview-icon", ["dark-blue", "dark-blue"], "/\\.lvproj$/i"],
            ["laravel-icon", ["medium-orange", "medium-orange"], "/\\.blade\\.php$/i", null, false, null, "/\\.php\\.blade$/i", "/^Laravel$/i"],
            ["lasso-icon", ["dark-blue", "dark-blue"], "/\\.lasso$|\\.las$/i", null, false, null, "/\\.lasso$/i", "/^Lasso$|^lass[0o]script$/i"],
            ...
            ["lean-icon", ["dark-purple", "dark-purple"], "/\\.lean$/i", null, false, "/^lean$/", "/\\.lean$/i", "/^lean$/i"],
            ...
            ["lisp-icon", ["medium-red", "medium-red"], "/\\.lsp$/i", null, false, "/^newlisp$/", "/\\.newlisp$/i", "/^Lisp$|^newlisp$/i"],
            ["lisp-icon", ["dark-red", "dark-red"], "/\\.lisp$/i", null, false, "/^lisp$/", "/\\.lisp$/i", "/^lisp$/i"],
            ["lisp-icon", ["medium-maroon", "medium-maroon"], "/\\.l$|\\.nl$/i", null, false, "/picolisp|pil/"],
            ["lisp-icon", ["medium-blue", "medium-blue"], "/\\.ny$|\\.sexp$/i"],
            ["lisp-icon", ["medium-purple", "medium-purple"], "/\\.podsl$/i"],
            ["ls-icon", ["medium-blue", "medium-blue"], "/\\.ls$/i", null, false, null, "/\\.livescript$/i", "/^LiveScript$|^(?:ls|live-script)$/i"],
            ["ls-icon", ["dark-blue", "dark-blue"], "/\\._ls$/i"],
            ["ls-icon", ["medium-green", "medium-green"], "/^Slakefile$/"],
            ["llvm-icon", ["dark-green", "dark-green"], "/\\.ll$/i", null, false, "/^llvm$/", "/\\.llvm$/i", "/^llvm$/i"],
            ["llvm-icon", ["medium-yellow", "dark-yellow"], "/\\.clang-format$/i"],
            ["mobile-icon", ["dark-blue", "dark-blue"], "/\\.xm$/i", null, false, "/^logos$/", "/\\.logos$/i", "/^l[0o]g[0o]s$/i"],
            ["mobile-icon", ["dark-red", "dark-red"], "/\\.xi$/i"],
            ["logtalk-icon", ["medium-red", "medium-red"], "/\\.(?:logtalk|lgt)$/i", null, false, null, "/\\.logtalk$/i", "/^Logtalk$/i"],
            ["lookml-icon", ["medium-purple", "medium-purple"], "/\\.lookml$/i"],
            ["lsl-icon", ["medium-cyan", "medium-cyan"], "/\\.lsl$/i", null, false, "/^lsl$/", "/\\.lsl$/i", "/^lsl$/i"],
            ["lsl-icon", ["dark-cyan", "dark-cyan"], "/\\.lslp$/i"],
            ["lua-icon", ["medium-blue", "medium-blue"], "/\\.lua$/i", null, false, "/^lua$/", "/\\.lua$/i", "/^lua$/i"],
            ["lua-icon", ["dark-blue", "dark-blue"], "/\\.pd_lua$/i"],
            ["lua-icon", ["dark-purple", "dark-purple"], "/\\.rbxs$/i"],
            ["lua-icon", ["dark-red", "dark-red"], "/\\.wlua$/i"],
            ["checklist-icon", ["medium-yellow", "medium-yellow"], "/^Makefile|^makefile$/", null, false, "/^make$/", "/\\.makefile$/i", "/^Makefile$|^(?:bsdmake|make|mf)$/i"],
            ...
            ["mako-icon", ["dark-blue", "dark-blue"], "/\\.mak?o$/i", null, false, null, "/\\.mako$/i", "/^Mako$/i"],
            ["manpage-icon", ["dark-green", "dark-green"], "/\\.(?:1(?:[bcmsx]|has|in)?|[24568]|3(?:avl|bsm|3c|in|m|qt|x)?|7(?:d|fs|i|ipp|m|p)?|9[efps]?|chem|eqn|groff|man|mandoc|mdoc|me|mom|n|nroff|pic|tmac|tmac-u|tr|troff)$/i", null, false, "/man|mandoc|(?:[gnt]|dit)roff/i", "/\\.[gt]?roff$/i", "/^Manual Page$|^(?:[gtn]?roff|manpage)$/i", "/^\\.TH[ \\t]+(?:\\S+)|^'\\\\\" [tre]+(?=\\s|$)/"],
            ["manpage-icon", ["dark-maroon", "dark-maroon"], "/\\.(?:rnh|rno|roff|run|runoff)$/i", null, false, "/^runoff$/", "/\\.runoff$/i", "/^Manual Page$|^run[0o]ff$/i"],
            ["mapbox-icon", ["medium-cyan", "medium-cyan"], "/\\.mss$/i", null, false, null, "/\\.mss$/i", "/^Mapbox$|^Carto(?:CSS)?$/i"],
            ["markdown-icon", ["medium-blue", "medium-blue"], "/\\.(?:md|mdown|markdown|mkd|mkdown|mkdn|rmd|ron)$/i", null, false, null, "/\\.gfm$/i", "/^Markdown$/i"],
            ["mathematica-icon", ["dark-red", "dark-red"], "/\\.mathematica$|\\.nbp$/i", null, false, null, "/\\.mathematica$/i", "/^Mathematica$|^mma$/i"],
            ...
            ["matlab-icon", ["medium-yellow", "medium-yellow"], "/\\.matlab$/i", null, false, null, "/\\.(?:matlab|octave)$/i", "/^MATLAB$|^[0o]ctave$/i"],
            ...
            ["maxscript-icon", ["dark-blue", "dark-blue"], "/\\.ms$/i", null, false, null, "/\\.maxscript$/i", "/^MAXScript$/i"],
            ...
            ["mediawiki-icon", ["medium-yellow", "medium-yellow"], "/\\.mediawiki$/i", null, false, "/^mediawiki$/", "/\\.mediawiki$/i", "/^mediawiki$/i"],
            ["mediawiki-icon", ["medium-orange", "medium-orange"], "/\\.wiki$/i"],
            ["bullhorn-icon", ["medium-orange", "medium-orange"], "/^\\.mention-bot$/i"],
            ["mercury-icon", ["medium-cyan", "medium-cyan"], "/\\.moo$/i", null, false, "/^mmi$/", "/\\.mercury$/i", "/^Mercury$/i"],
            ...
            ["minecraft-icon", ["dark-green", "dark-green"], "/^mcmod\\.info$/i", null, false, null, "/\\.forge-config$/i", "/^Minecraft$/i"],
            ["mirah-icon", ["medium-blue", "medium-blue"], "/\\.dr?uby$/g", null, false, "/^mirah$/", "/\\.mirah$/i", "/^mirah$/i"],
            ["mirah-icon", ["light-blue", "light-blue"], "/\\.mir(?:ah)?$/g"],
            ["model-icon", ["medium-red", "medium-red"], "/\\.obj$/i", null, false, null, "/\\.wavefront\\.obj$/i"],
            ["model-icon", ["dark-blue", "dark-blue"], "/\\.mtl$/i", null, false, null, "/\\.wavefront\\.mtl$/i"],
            ["model-icon", ["dark-green", "dark-green"], "/\\.stl$/i"],
            ["model-icon", ["medium-orange", "medium-orange"], "/\\.u3d$/i"],
            ["circle-icon", ["light-red", "light-red"], "/\\.mo$/i", null, false, null, "/\\.modelica(?:script)?$/i", "/^Modelica$/i"],
            ["modula2-icon", ["medium-blue", "medium-blue"], "/\\.mod$/i", null, false, null, "/(?:^|\\.)modula-?2(?:\\.|$)/i", "/^Modula-2$/i"],
            ["modula2-icon", ["medium-green", "medium-green"], "/\\.def$/i"],
            ["modula2-icon", ["medium-red", "medium-red"], "/\\.m2$/i"],
            ["monkey-icon", ["medium-maroon", "medium-maroon"], "/\\.monkey$/i", null, false, null, "/\\.monkey$/i", "/^Monkey$/i"],
            ["moon-icon", ["medium-yellow", "medium-yellow"], "/\\.moon$/i", null, false, "/^moon$/", "/\\.moon$/i", "/^MoonScript$/i"],
            ["mruby-icon", ["medium-red", "medium-red"], "/\\.mrb$/i", null, false, "/^mruby$/"],
            ...
            ["music-icon", ["dark-blue", "dark-blue"], "/\\.midi?$/i", null, false, null, null, null, "/^MThd/"],
            ["music-icon", ["medium-green", "medium-green"], "/\\.ly$/i", null, false, null, "/\\.(?:At)?lilypond-/i", "/^Lily\\s*Pond$/i"],
            ["music-icon", ["dark-green", "dark-green"], "/\\.ily$/i"],
            ["music-icon", ["dark-red", "dark-red"], "/\\.pd$/i"],
            ["mustache-icon", ["medium-orange", "medium-orange"], "/\\.(?:hbs|handlebars|mustache)$/i", null, false, null, "/(?:^|\\.)(?:mustache|handlebars)(?:\\.|$)/i", "/^Mustache$|^(?:hbs|htmlbars|handlebars)$/i"],
            ["nant-icon", ["medium-orange", "medium-orange"], "/\\.build$/i", null, false, null, "/\\.nant-build$/i", "/^NAnt$/i"],
            ["earth-icon", ["medium-green", "medium-green"], "/\\.ncl$/i", null, false, null, "/\\.ncl$/i", "/^NCAR Command Language \\(NCL\\)$/i"],
            ["neko-icon", ["medium-orange", "medium-orange"], "/\\.neko$/i", null, false, "/^neko$/", "/\\.neko$/i", "/^nek[0o]$/i"],
            ["amx-icon", ["medium-blue", "medium-blue"], "/\\.axs$/i"],
            ["amx-icon", ["dark-blue", "dark-blue"], "/\\.axi$/i"],
            ["netlogo-icon", ["medium-red", "medium-red"], "/\\.nlogo$/i"],
            ["nginx-icon", ["medium-green", "medium-green"], "/\\.nginxconf$/i", null, false, null, "/\\.nginx$/i", "/^NGINX$|^nginx[\\W_ \\t]?c[0o]nfigurati[0o]n[\\W_ \\t]?file$/i"],
            ["nib-icon", ["dark-orange", "dark-orange"], "/\\.nib$/i"],
            ["nimrod-icon", ["medium-green", "medium-green"], "/\\.nim(?:rod)?$/i", null, false, null, "/\\.nim$/i", "/^Nimrod$/i"],
            ["shuriken-icon", ["medium-blue", "medium-blue"], "/\\.ninja$/i", null, false, "/^ninja$/", "/\\.ninja$/i", "/^ninja$/i"],
            ["nit-icon", ["dark-green", "dark-green"], "/\\.nit$/i", null, false, null, "/\\.nit$/i", "/^Nit$/i"],
            ["nix-icon", ["medium-cyan", "medium-cyan"], "/\\.nix$/i", null, false, null, "/\\.nix$/i", "/^Nix$|^nix[0o]s$/i"],
            ["nmap-icon", ["dark-blue", "dark-blue"], "/\\.nse$/i", null, false, null, "/\\.nmap$/i", "/^Nmap$/i"],
            ["node-icon", ["medium-green", "medium-green"], "/\\.njs$|\\.nvmrc$/i"],
            ["node-icon", ["dark-green", "dark-green"], "/\\.node-version$/i"],
            ["nsis-icon", ["medium-purple", "medium-purple"], "/\\.nsi$/i", null, false, "/^nsis$/", "/\\.nsis$/i", "/^nsis$/i"],
            ["nsis-icon", ["dark-cyan", "dark-cyan"], "/\\.nsh$/i"],
            ["recycle-icon", ["light-green", "light-green"], "/\\.nu$/i", null, false, "/^nush$/", "/\\.nu$/i", "/^Nu$|^nush$/i"],
            ...
            ["objc-icon", ["medium-blue", "medium-blue"], "/\\.mm?$/i", null, false, null, "/\\.objc(?:pp)?$/i", "/^Objective-C$|^(?:Obj-?C|ObjectiveC)(?:\\+\\+)?$/i"],
            ["objc-icon", ["dark-red", "dark-red"], "/\\.pch$/i"],
            ["objc-icon", ["dark-green", "dark-green"], "/\\.x$/i"],
            ["objj-icon", ["dark-orange", "dark-orange"], "/\\.j$/i", null, false, null, "/\\.objj$/i", "/^Objective-J$|^(?:Obj-?J|ObjectiveJ)$/i"],
            ["objj-icon", ["dark-red", "dark-red"], "/\\.sj$/i"],
            ["ocaml-icon", ["medium-orange", "medium-orange"], "/\\.ml$/i", null, false, "/ocaml(?:run|script)?/", "/\\.ocaml$/i", "/^OCaml$/i"],
            ...
            ["ocaml-icon", ["dark-green", "dark-green"], "/\\.mll$/i", null, false, "/^ocamllex$/", "/\\.ocamllex$/i", "/^OCaml$|^[0o]camllex$/i"],
            ["ocaml-icon", ["dark-yellow", "dark-yellow"], "/\\.mly$/i", null, false, "/^menhir$/", "/\\.menhir$/i", "/^OCaml$|^menhir$/i"],
            ["ooc-icon", ["medium-green", "medium-green"], "/\\.ooc$/i", null, false, null, "/\\.ooc$/i", "/^OOC$/i"],
            ["opa-icon", ["medium-blue", "medium-blue"], "/\\.opa$/i", null, false, null, "/\\.opa$/i", "/^Opa$/i"],
            ["opencl-icon", ["medium-red", "medium-red"], "/\\.opencl$/i", null, false, null, "/\\.opencl$/i", "/^OpenCL$/i"],
            ["progress-icon", ["medium-red", "medium-red"], "/\\.p$/i", null, false, null, "/\\.abl$/i", "/^OpenEdge ABL$|^(?:progress|openedge|abl)$/i"],
            ...
            ["scad-icon", ["medium-orange", "medium-orange"], "/\\.scad$/i", null, false, null, "/\\.scad$/i", "/^OpenSCAD$/i"],
            ["scad-icon", ["medium-yellow", "medium-yellow"], "/\\.jscad$/i"],
            ["org-icon", ["dark-green", "dark-green"], "/\\.org$/i"],
            ["osx-icon", ["medium-red", "medium-red"], "/\\.dmg$/i", null, false, null, null, null, "/^\\x78\\x01\\x73\\x0D\\x62\\x62\\x60/"],
            ["ox-icon", ["medium-cyan", "dark-cyan"], "/\\.ox$/i", null, false, null, "/\\.ox$/i", "/^Ox$/i"],
            ["ox-icon", ["medium-green", "dark-green"], "/\\.oxh$/i"],
            ["ox-icon", ["medium-blue", "dark-blue"], "/\\.oxo$/i"],
            ["oxygene-icon", ["medium-cyan", "dark-cyan"], "/\\.oxygene$/i", null, false, null, "/\\.oxygene$/i", "/^Oxygene$/i"],
            ["oz-icon", ["medium-yellow", "medium-yellow"], "/\\.oz$/i", null, false, null, "/\\.oz$/i", "/^Oz$/i"],
            ["pan-icon", ["medium-red", "medium-red"], "/\\.pan$/i"],
            ["papyrus-icon", ["medium-green", "medium-green"], "/\\.psc$/i", null, false, null, "/(?:^|\\.)(?:papyrus\\.skyrim|compiled-?papyrus|papyrus-assembly)(?:\\.|$)/i", "/^Papyrus$/i"],
            ["parrot-icon", ["medium-green", "medium-green"], "/\\.parrot$/i", null, false, "/^parrot$/"],
            ["parrot-icon", ["dark-green", "dark-green"], "/\\.pasm$/i", null, false, null, "/\\.parrot\\.pasm$/i", "/^Parrot$|^pasm$/i"],
            ["parrot-icon", ["dark-blue", "dark-blue"], "/\\.pir$/i", null, false, null, "/\\.parrot\\.pir$/i", "/^Parrot$|^pir$/i"],
            ["pascal-icon", ["medium-purple", "medium-purple"], "/\\.pas(?:cal)?$/i", null, false, "/pascal|instantfpc/", "/\\.pascal$/i", "/^Pascal$/i"],
            ...
            ["pawn-icon", ["medium-orange", "medium-orange"], "/\\.pwn$/i", null, false, null, "/\\.pwn$/i", "/^PAWN$/i"],
            ["icon-file-pdf", ["medium-red", "medium-red"], "/\\.pdf$/i", null, false, null, null, null, "/^%PDF/"],
            ["perl-icon", ["medium-blue", "medium-blue"], "/\\.p(?:er)?l$|\\.t$/i", null, false, "/^perl$/", "/\\.perl$/i", "/^perl$/i"],
            ...
            ["perl6-icon", ["medium-purple", "medium-purple"], "/\\.pl6$/i", null, false, "/^perl6$/", "/(?:^|\\.)perl6(?:fe)?(?=\\.|$)/", "/^(?:pl6|Perl\\s*6)$/i"],
            ...
            ["phalcon-icon", ["medium-cyan", "medium-cyan"], "/\\.volt$/i", null, false, null, "/\\.volt$/i", "/^Phalcon$/i"],
            ["php-icon", ["dark-blue", "dark-blue"], "/\\.php(?:[st\\d]|_cs)?$/i", null, false, "/^php$/", "/\\.php$/i", "/^PHP$/i", "/^<\\?php/"],
            ["php-icon", ["dark-green", "dark-green"], "/^Phakefile/"],
            ["pickle-icon", ["dark-cyan", "dark-cyan"], "/\\.pkl$/i"],
            ["pike-icon", ["dark-cyan", "dark-cyan"], "/\\.pike$/i", null, false, "/^pike$/"],
            ["pike-icon", ["medium-blue", "medium-blue"], "/\\.pmod$/i"],
            ["sql-icon", ["medium-red", "medium-red"], "/\\.(?:pls|pck|pks|plb|plsql|pkb)$/i", null, false, null, "/\\.plsql(?:\\.oracle)?(?:\\.|$)/i", "/^PLSQL$/i"],
            ["pod-icon", ["dark-blue", "dark-blue"], "/\\.pod$/i"],
            ["pogo-icon", ["medium-orange", "dark-orange"], "/\\.pogo$/i", null, false, null, "/\\.pogoscript$/i", "/^PogoScript$/i"],
            ["pony-icon", ["light-maroon", "light-maroon"], "/\\.pony$/i", null, false, null, "/\\.pony$/i", "/^Pony$/i"],
            ["postcss-icon", ["dark-red", "dark-red"], "/\\.p(?:ost)?css$/i", null, false, "/^postcss$/", "/\\.postcss$/i", "/^p[0o]stcss$/i"],
            ["postcss-icon", ["dark-pink", "dark-pink"], "/\\.sss$/i", null, false, "/^sugarss$/", "/\\.sugarss$/i", "/^PostCSS$|^sugarss$/i"],
            ["postcss-icon", ["medium-orange", "dark-orange"], "/\\.postcssrc$/i"],
            ["postscript-icon", ["medium-red", "medium-red"], "/\\.ps$/i", null, false, null, "/\\.postscript$/i", "/^PostScript$|^p[0o]stscr$/i", "/^%!PS/"],
            ...
            ["powershell-icon", ["medium-blue", "medium-blue"], "/\\.ps1$/i", null, false, null, "/\\.powershell$/i", "/^PowerShell$|^p[0o]sh$/i"],
            ...
            ["processing-icon", ["dark-blue", "dark-blue"], "/\\.pde$/i", null, false, null, "/\\.processing$/i", "/^Processing$/i"],
            ["prolog-icon", ["medium-blue", "medium-blue"], "/\\.pro$/i", null, false, "/^swipl$/", "/\\.prolog$/i", "/^Prolog$/i"],
            ["prolog-icon", ["medium-cyan", "medium-cyan"], "/\\.prolog$/i"],
            ["prolog-icon", ["medium-purple", "medium-purple"], "/\\.yap$/i", null, false, "/^yap$/"],
            ["propeller-icon", ["medium-orange", "medium-orange"], "/\\.spin$/i", null, false, null, "/\\.spin$/i", "/^Propeller Spin$/i"],
            ["pug-icon", ["medium-red", "medium-red"], "/\\.pug$/i", null, false, null, "/\\.pug$/i", "/^Pug$/i"],
            ["puppet-icon", ["medium-purple", "medium-purple"], "/\\.pp$/i", null, false, "/^puppet$/", "/\\.puppet$/i", "/^puppet$/i"],
            ["puppet-icon", ["dark-blue", "dark-blue"], "/Modulefile$/i"],
            ["purebasic-icon", ["medium-red", "medium-red"], "/\\.pb$/i", null, false, "/^purebasic$/", "/\\.purebasic$/i", "/^purebasic$/i"],
            ["purebasic-icon", ["dark-orange", "dark-orange"], "/\\.pbi$/i"],
            ["purescript-icon", ["dark-purple", "dark-purple"], "/\\.purs$/i", null, false, null, "/\\.purescript$/i", "/^PureScript$/i"],
            ["python-icon", ["dark-blue", "dark-blue"], "/\\.py$|\\.bzl$|\\.py3$|\\.?(?:pypirc|pythonrc|python-venv)$/i", null, false, "/python[\\d.]*/", "/\\.python$/i", "/^Python$|^rusth[0o]n$/i"],
            ["python-icon", ["medium-blue", "medium-blue"], "/\\.ipy$/i"],
            ["python-icon", ["dark-green", "dark-green"], "/\\.isolate$|\\.gypi$|\\.pyt$/i"],
            ["python-icon", ["medium-orange", "medium-orange"], "/\\.pep$|\\.pyde$/i", null, false, "/^pep8$/", "/\\.pep8$/i", "/^Python$|^pep8$/i"],
            ...
            ["python-icon", ["medium-pink", "medium-pink"], "/\\.rpy$/i", null, false, null, "/\\.renpy$/i", "/^Python$|^Ren'?Py$/i"],
            ...
            ["r-icon", ["medium-blue", "medium-blue"], "/\\.(?:r|Rprofile|rsx|rd)$/i", null, false, "/^Rscript$/", "/\\.r$/i", "/^R$|^(?:Rscript|splus|Rlang)$/i"],
            ["racket-icon", ["medium-red", "medium-red"], "/\\.rkt$/i", null, false, "/^racket$/", "/\\.racket$/i", "/^racket$/i"],
            ["racket-icon", ["medium-blue", "medium-blue"], "/\\.rktd$/i"],
            ["racket-icon", ["light-red", "light-red"], "/\\.rktl$/i"],
            ["racket-icon", ["dark-blue", "dark-blue"], "/\\.scrbl$/i", null, false, "/^scribble$/", "/\\.scribble$/i", "/^Racket$|^scribble$/i"],
            ["raml-icon", ["medium-cyan", "medium-cyan"], "/\\.raml$/i", null, false, null, "/\\.raml$/i", "/^RAML$/i"],
            ["rascal-icon", ["medium-yellow", "medium-yellow"], "/\\.rsc$/i", null, false, null, "/\\.rascal$/i", "/^Rascal$/i"],
            ["rdoc-icon", ["medium-red", "medium-red"], "/\\.rdoc$/i", null, false, null, "/\\.rdoc$/i", "/^RDoc$/i"],
            ...
            ["reason-icon", ["medium-red", "medium-red"], "/\\.re$/i", null, false, "/^reason$/", "/\\.reason$/i", "/^reas[0o]n$/i"],
            ["reason-icon", ["medium-orange", "medium-orange"], "/\\.rei$/i"],
            ["rebol-icon", ["dark-green", "dark-green"], "/\\.reb(?:ol)?$/i", null, false, "/^rebol$/", "/\\.rebol$/i", "/^reb[0o]l$/i"],
            ["rebol-icon", ["dark-red", "dark-red"], "/\\.r2$/i"],
            ["rebol-icon", ["dark-blue", "dark-blue"], "/\\.r3$/i"],
            ["red-icon", ["medium-red", "medium-red"], "/\\.red$/i", null, false, null, "/\\.red$/i", "/^Red$|^red\\/?system$/i"],
            ["red-icon", ["light-red", "light-red"], "/\\.reds$/i"],
            ["red-hat-icon", ["medium-red", "medium-red"], "/\\.rpm$/i"],
            ["red-hat-icon", ["dark-red", "dark-red"], "/\\.spec$/i"],
            ["regex-icon", ["medium-green", "medium-green"], "/\\.regexp?$/i", null, false, null, "/(?:\\.|^)regexp?(?:\\.|$)/i", "/^RegExp$/i"],
            ["android-icon", ["dark-maroon", "dark-maroon"], "/\\.rsh$/i"],
            ["rst-icon", ["dark-blue", "dark-blue"], "/\\.re?st(?:\\.txt)?$/i", null, false, null, "/\\.restructuredtext$/i", "/^reStructuredText$|^re?st$/i"],
            ["rexx-icon", ["medium-red", "medium-red"], "/\\.rexx?$/i", null, false, "/rexx|regina/i", "/\\.rexx$/i", "/^REXX$/i"],
            ["rexx-icon", ["medium-blue", "medium-blue"], "/\\.pprx$/i"],
            ["riot-icon", ["medium-red", "medium-red"], "/\\.tag$/i", null, false, null, "/\\.riot$/i", "/^RiotJS$/i"],
            ...
            ["ruby-icon", ["medium-red", "medium-red"], "/\\.(?:rb|ru|ruby|erb|gemspec|god|mspec|pluginspec|podspec|rabl|rake|opal)$|^\\.?(?:irbrc|gemrc|pryrc|rspec|ruby-(?:gemset|version))$/i", null, false, "/(?:mac|j)?ruby|rake|rbx/", "/\\.ruby$/i", "/^Ruby$|^(?:rbx?|rake|jruby|macruby)$/i"],
            ...
            ["rust-icon", ["medium-maroon", "medium-maroon"], "/\\.rs$/i", null, false, "/^rust$/", "/\\.rust$/i", "/^rust$/i"],
            ["rust-icon", ["light-maroon", "light-maroon"], "/\\.rlib$/i"],
            ["sage-icon", ["medium-blue", "medium-blue"], "/\\.sage$/i", null, false, "/^sage$/", "/\\.sage$/i", "/^sage$/i"],
            ["sage-icon", ["dark-blue", "dark-blue"], "/\\.sagews$/i"],
            ["saltstack-icon", ["medium-blue", "dark-blue"], "/\\.sls$/i", null, false, null, "/\\.salt$/i", "/^SaltStack$|^Salt(?:State)?$/i"],
            ["sas-icon", ["medium-blue", "medium-blue"], "/\\.sas$/i", null, false, null, "/\\.sas$/i", "/^SAS$/i"],
            ["sass-icon", ["light-pink", "light-pink"], "/\\.scss$/i", null, false, "/^scss$/", "/\\.scss$/i", "/^Sass$|^scss$/i"],
            ["sass-icon", ["dark-pink", "dark-pink"], "/\\.sass$/i", null, false, "/^sass$/", "/\\.sass$/i", "/^sass$/i"],
            ["sbt-icon", ["dark-purple", "dark-purple"], "/\\.sbt$/i"],
            ["scala-icon", ["medium-red", "medium-red"], "/\\.(?:sc|scala)$/i", null, false, "/^scala$/", "/\\.scala$/i", "/^Scala$/i"],
            ["scheme-icon", ["medium-red", "medium-red"], "/\\.scm$/i", null, false, "/guile|bigloo|chicken/", "/\\.scheme$/i", "/^Scheme$/i"],
            ["scheme-icon", ["medium-blue", "medium-blue"], "/\\.sld$/i"],
            ["scheme-icon", ["medium-purple", "medium-purple"], "/\\.sps$/i"],
            ["scilab-icon", ["dark-purple", "dark-purple"], "/\\.sci$/i", null, false, "/^scilab$/", "/\\.scilab$/i", "/^scilab$/i"],
            ["scilab-icon", ["dark-blue", "dark-blue"], "/\\.sce$/i"],
            ["scilab-icon", ["dark-cyan", "dark-cyan"], "/\\.tst$/i"],
            ["secret-icon", [null, null], "/\\.secret$/i"],
            ["self-icon", ["dark-blue", "dark-blue"], "/\\.self$/i", null, false, null, "/\\.self$/i", "/^Self$/i"],
            ["graph-icon", ["light-red", "light-red"], "/\\.csv$/i", null, false, null, "/(?:^|\\.)csv(?:\\.semicolon)?(?:\\.|$)/i"],
            ...
            ["terminal-icon", ["medium-purple", "medium-purple"], "/\\.(?:sh|rc|bats|bash|tool|install|command)$/i", null, false, "/bash|sh|zsh|rc/", "/\\.shell$/i", "/^(?:sh|shell|Shell-?Script|Bash)$/i"],
            ...
            ["terminal-icon", ["medium-yellow", "dark-yellow"], "/\\.sh-session$/i", null, false, null, "/\\.shell-session$/i", "/^(?:Bash|Shell|Sh)[-\\s]*(?:Session|Console)$/i"],
            ["terminal-icon", ["medium-blue", "medium-blue"], "/\\.zsh(?:-theme|_history)?$|^\\.?(?:antigen|zpreztorc|zlogin|zlogout|zprofile|zshenv|zshrc)$|\\.tmux$/i"],
            ["terminal-icon", ["medium-green", "medium-green"], "/\\.fish$|^\\.fishrc$|\\.tcsh$/i", null, false, "/^fish$/", "/\\.fish$/i", "/^fish$/i"],
            ...
            ["terminal-icon", ["dark-purple", "dark-purple"], "/^\\/(?:private\\/)?etc\\/(?:[^\\/]+\\/)*(?:profile$|nanorc$|rc\\.|csh\\.)/i", null, true],
            ...
            ["silverstripe-icon", ["medium-blue", "medium-blue"], "/\\.ss$/i", null, false, null, "/(?:^|\\.)ss(?:template)?(?:\\.|$)/i", "/^SilverStripe$/i"],
            ["sketch-icon", ["medium-orange", "medium-orange"], "/\\.sketch$/i"],
            ["slash-icon", ["dark-blue", "dark-blue"], "/\\.sl$/i", null, false, null, "/\\.slash$/i", "/^Slash$/i"],
            ["android-icon", ["medium-green", "medium-green"], "/\\.smali$/i", null, false, null, "/\\.smali$/i", "/^Smali$/i"],
            ["smarty-icon", ["medium-yellow", "dark-yellow"], "/\\.tpl$/i", null, false, null, "/\\.smarty$/i", "/^Smarty$/i"],
            ["snyk-icon", ["dark-purple", "dark-purple"], "/\\.snyk$/i"],
            ["clojure-icon", ["medium-yellow", "dark-yellow"], "/\\.(?:sma|sp)$/i", null, false, null, "/\\.sp$/i", "/^SourcePawn$|^s[0o]urcem[0o]d$/i"],
            ["sparql-icon", ["medium-blue", "medium-blue"], "/\\.sparql$/i", null, false, null, "/\\.rq$/i", "/^SPARQL$/i"],
            ["sparql-icon", ["dark-blue", "dark-blue"], "/\\.rq$/i"],
            ["sqf-icon", ["dark-maroon", "dark-maroon"], "/\\.sqf$/i", null, false, "/^sqf$/", "/\\.sqf$/i", "/^sqf$/i"],
            ["sqf-icon", ["dark-red", "dark-red"], "/\\.hqf$/i"],
            ["sql-icon", ["medium-orange", "medium-orange"], "/\\.(?:my)?sql$/i", null, false, "/^sql$/", "/\\.sql$/i", "/^sql$/i"],
            ...
            ["squirrel-icon", ["medium-maroon", "medium-maroon"], "/\\.nut$/i", null, false, null, "/\\.nut$/i", "/^Squirrel$/i"],
            ...
            ["stan-icon", ["medium-red", "medium-red"], "/\\.stan$/i", null, false, null, "/\\.stan$/i", "/^Stan$/i"],
            ["stata-icon", ["medium-blue", "medium-blue"], "/\\.do$/i", null, false, "/^stata$/", "/\\.stata$/i", "/^stata$/i"],
            ["stata-icon", ["dark-blue", "dark-blue"], "/\\.ado$/i"],
            ["stata-icon", ["light-blue", "light-blue"], "/\\.doh$/i"],
            ["stata-icon", ["medium-cyan", "medium-cyan"], "/\\.ihlp$/i"],
            ["stata-icon", ["dark-cyan", "dark-cyan"], "/\\.mata$/i", null, false, "/^mata$/", "/\\.mata$/i", "/^Stata$|^mata$/i"],
            ...
            ["strings-icon", ["medium-red", "medium-red"], "/\\.strings$/i", null, false, null, "/\\.strings$/i", "/^Strings$/i"],
            ["stylus-icon", ["medium-green", "medium-green"], "/\\.styl$/i", null, false, null, "/\\.stylus$/i", "/^Stylus$/i"],
            ...
            ["scd-icon", ["medium-red", "medium-red"], "/\\.scd$/i", null, false, "/sclang|scsynth/", "/\\.supercollider$/i", "/^SuperCollider$/i"],
            ["svg-icon", ["dark-yellow", "dark-yellow"], "/\\.svg$/i", null, false, null, "/\\.svg$/i", "/^SVG$/i"],
            ["swift-icon", ["medium-green", "medium-green"], "/\\.swift$/i", null, false, null, "/\\.swift$/i", "/^Swift$/i"],
            ...
            ["tcl-icon", ["dark-orange", "dark-orange"], "/\\.tcl$/i", null, false, "/tclsh|wish/", "/\\.tcl$/i", "/^Tcl$/i"],
            ["tcl-icon", ["medium-orange", "medium-orange"], "/\\.adp$/i"],
            ["tcl-icon", ["medium-red", "medium-red"], "/\\.tm$/i"],
            ["coffee-icon", ["medium-orange", "medium-orange"], "/\\.tea$/i", null, false, null, "/\\.tea$/i", "/^Tea$/i"],
            ...
            ["terraform-icon", ["dark-purple", "dark-purple"], "/\\.tf(?:vars)?$/i", null, false, null, "/\\.terra(?:form)?$/i", "/^Terraform$/i"],
            ["tex-icon", ["medium-blue", "dark-blue"], "/\\.tex$|\\.ltx$|\\.lbx$/i", null, false, null, "/(?:^|\\.)latex(?:\\.|$)/i", "/^TeX$|^latex$/i"],
            ["tex-icon", ["medium-green", "dark-green"], "/\\.aux$|\\.ins$/i"],
            ["tex-icon", ["medium-red", "dark-red"], "/\\.sty$|\\.texi$/i", null, false, null, "/(?:^|\\.)tex(?:\\.|$)/i", "/^TeX$/i"],
            ["tex-icon", ["medium-maroon", "dark-maroon"], "/\\.dtx$/i"],
            ["tex-icon", ["medium-orange", "dark-orange"], "/\\.cls$|\\.mkiv$|\\.mkvi$|\\.mkii$/i"],
            ["icon-file-text", ["medium-blue", "medium-blue"], "/\\.te?xt$|\\.irclog$|\\.uot$/i", null, false, null, null, null, "/^\\xEF\\xBB\\xBF|^\\xFF\\xFE/"],
            ["icon-file-text", ["medium-maroon", "medium-maroon"], "/\\.log$|^Terminal[-_\\s]Saved[-_\\s]Output$|\\.brf$/i"],
            ["icon-file-text", ["dark-red", "dark-red"], "/\\.git[\\/\\\\]description$/", null, true],
            ...
            ["textile-icon", ["medium-orange", "medium-orange"], "/\\.textile$/i", null, false, null, "/\\.textile$/i", "/^Textile$/i"],
            ...
            ["tsx-icon", ["light-blue", "light-blue"], "/\\.tsx$/i", null, false, null, "/\\.tsx$/i", "/^TSX$/i"],
            ["turing-icon", ["medium-red", "medium-red"], "/\\.tu$/i", null, false, null, "/\\.turing$/i", "/^Turing$/i"],
            ["twig-icon", ["medium-green", "medium-green"], "/\\.twig$/i", null, false, null, "/\\.twig$/i", "/^Twig$/i"],
            ["txl-icon", ["medium-orange", "medium-orange"], "/\\.txl$/i", null, false, null, "/\\.txl$/i", "/^TXL$/i"],
            ["ts-icon", ["medium-blue", "medium-blue"], "/\\.ts$/i", null, false, null, "/\\.ts$/i", "/^(?:ts|Type[-\\s]*Script)$/i"],
            ["unity3d-icon", ["dark-blue", "dark-blue"], "/\\.anim$/i", null, false, "/^shaderlab$/", "/\\.shaderlab$/i", "/^Unity3D$|^shaderlab$/i"],
            ...
            ["unreal-icon", [null, null], "/\\.uc$/i", null, false, null, "/\\.uc$/i", "/^UnrealScript$/i"],
            ["link-icon", ["dark-blue", "dark-blue"], "/\\.url$/i"],
            ["urweb-icon", ["medium-maroon", "medium-maroon"], "/\\.ur$/i", null, false, null, "/\\.ur$/i", "/^UrWeb$|^Ur(?:\\/Web)?$/i"],
            ["urweb-icon", ["dark-blue", "dark-blue"], "/\\.urs$/i"],
            ["vagrant-icon", ["medium-cyan", "medium-cyan"], "/^Vagrantfile$/i"],
            ["gnome-icon", ["medium-purple", "medium-purple"], "/\\.vala$/i", null, false, "/^vala$/", "/\\.vala$/i", "/^vala$/i"],
            ["gnome-icon", ["dark-purple", "dark-purple"], "/\\.vapi$/i"],
            ["varnish-icon", ["dark-blue", "dark-blue"], "/\\.vcl$/i", null, false, null, "/(?:^|\\.)(?:varnish|vcl)(?:\\.|$)/i", "/^VCL$/i"],
            ["verilog-icon", ["dark-green", "dark-green"], "/\\.v$/i", null, false, "/^verilog$/", "/\\.verilog$/i", "/^veril[0o]g$/i"],
            ["verilog-icon", ["medium-red", "medium-red"], "/\\.veo$/i"],
            ["vhdl-icon", ["dark-green", "dark-green"], "/\\.vhdl$/i", null, false, "/^vhdl$/", "/\\.vhdl$/i", "/^vhdl$/i"],
            ...
            ["video-icon", ["medium-blue", "medium-blue"], "/\\.3gpp?$/i", null, false, null, null, null, "/^.{4}ftyp3g/"],
            ["video-icon", ["dark-blue", "dark-blue"], "/\\.(?:mp4|m4v|h264)$/i", null, false, null, null, null, "/^.{4}ftyp/"],
            ["video-icon", ["medium-blue", "medium-blue"], "/\\.avi$/i", null, false, null, null, null, "/^MLVI/"],
            ["video-icon", ["medium-cyan", "medium-cyan"], "/\\.mov$/i", null, false, null, null, null, "/^.{4}moov/"],
            ["video-icon", ["medium-purple", "medium-purple"], "/\\.mkv$/i", null, false, null, null, null, "/^\\x1AEß£\\x93B\\x82\\x88matroska/"],
            ["video-icon", ["medium-red", "medium-red"], "/\\.flv$/i", null, false, null, null, null, "/^FLV\\x01/"],
            ["video-icon", ["dark-blue", "dark-blue"], "/\\.webm$/i", null, false, null, null, null, "/^\\x1A\\x45\\xDF\\xA3/"],
            ["video-icon", ["medium-red", "medium-red"], "/\\.mpe?g$/i", null, false, null, null, null, "/^\\0{2}\\x01[\\xB3\\xBA]/"],
            ["video-icon", ["dark-purple", "dark-purple"], "/\\.(?:asf|wmv)$/i", null, false, null, null, null, "/^0&²u\\x8EfÏ\\x11¦Ù\\0ª\\0bÎl/"],
            ["video-icon", ["medium-orange", "medium-orange"], "/\\.(?:ogm|og[gv])$/i", null, false, null, null, null, "/^OggS/"],
            ["vim-icon", ["medium-green", "medium-green"], "/\\.(?:vim|n?vimrc)$/i", null, false, "/Vim?/i", "/\\.viml$/i", "/^(?:VimL?|NVim|Vim\\s*Script)$/i"],
            ["vim-icon", ["dark-green", "dark-green"], "/^[gn_]?vim(?:rc|info)$/i"],
            ["vs-icon", ["medium-blue", "medium-blue"], "/\\.(?:vba?|fr[mx]|bas)$/i", null, false, null, "/\\.vbnet$/i", "/^Visual Studio$|^vb\\.?net$/i"],
            ...
            ["vue-icon", ["light-green", "light-green"], "/\\.vue$/i", null, false, null, "/\\.vue$/i", "/^Vue$/i"],
            ["owl-icon", ["dark-blue", "dark-blue"], "/\\.owl$/i"],
            ["windows-icon", ["medium-purple", "medium-purple"], "/\\.bat$|\\.cmd$/i", null, false, null, "/(?:^|\\.)(?:bat|dosbatch)(?:\\.|$)/i", "/^(?:bat|(?:DOS|Win)?Batch)$/i"],
            ["windows-icon", [null, null], "/\\.(?:exe|com|msi)$/i"],
            ["windows-icon", ["medium-blue", "medium-blue"], "/\\.reg$/i"],
            ["x10-icon", ["light-maroon", "light-maroon"], "/\\.x10$/i", null, false, null, "/\\.x10$/i", "/^X10$|^xten$/i"],
            ...
            ["sql-icon", ["dark-red", "dark-red"], "/\\.(?:xquery|xq|xql|xqm|xqy)$/i", null, false, null, "/\\.xq$/i", "/^XQuery$/i"],
            ["xtend-icon", ["dark-purple", "dark-purple"], "/\\.xtend$/i", null, false, null, "/\\.xtend$/i", "/^Xtend$/i"],
            ["yang-icon", ["medium-yellow", "medium-yellow"], "/\\.yang$/i", null, false, null, "/\\.yang$/i", "/^YANG$/i"],
            ...
            ["doge-icon", ["medium-yellow", "medium-yellow"], "/\\.djs$/i", 0, false, null, "/\\.dogescript$/i", "/^Dogescript$/i"],
